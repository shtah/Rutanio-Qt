...
public:
    CTestNetParams() {
        ...
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 5218499;
        genesis.nTime  = 1542885720;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x000000a45fb1d49065d6bad6ca84e5130dc319e0db5003d14a6c201a5b2895a0"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testseednode1.rutan.cloud", "testseednode2.rutan.network"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 68); // rutanio test net
...
public:
    CRegTestParams() {
        ...
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 232431;
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 18999;
        strDataDir = "regtest";
//        MineGenesis(genesis);
        assert(hashGenesisBlock == uint256("0x000001eaf5fc73c5a2ded387a256d79b34b0acaaead5767a52c8c6081b79d031"));
